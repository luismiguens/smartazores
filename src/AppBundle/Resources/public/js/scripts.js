...
recaptchaSiteKey = '6LeebVkUAAAAAGqMazcSlKYo45HHA8PUUtyVx0CL';
...
googleMapAPIKey = 'AIzaSyC5X_uYqtdVatwL2YTcwiwxwIpjGJhHwgw';
...
jQuery(document).ready(function () {
    ...
    if (jQuery('[data-scroll]').length) {
        jQuery.getScript('bundles/app/js/plugins/scrollTo/jquery.scrollTo.min.js');
    }
    ...
    if (headerScroll === 'fixed') {
        if (jQuery('.header-menu-container').length) {
            jQuery.getScript('bundles/app/js/plugins/waypoint/jquery.waypoints.min.js', function () {
                jQuery.getScript('bundles/app/js/plugins/waypoint/sticky.min.js', function () {
                    jQuery.getScript('bundles/app/js/plugins/scrollTo/jquery.scrollTo.min.js', function () {
                        fixedHeaderfn();
                    });
                });
            });
    ...
    if (jQuery('.gfort-swiper-slider').length) {
        jQuery.getScript('bundles/app/js/plugins/swiper/js/swiper.min.js', function () {
            swiperSliderfn();
    ...
    if (jQuery('.subscribe-form-block').length) {
        jQuery.getScript('bundles/app/js/plugins/ajaxchimp/jquery.ajaxchimp.min.js', function () {
            gfortmailchimpfn();
        });
    }
...
//        jQuery.getScript('js/plugins/gfortSelect/gfortSelect.min.js', function () {
        jQuery.getScript('bundles/app/js/plugins/gfortSelect/gfortSelect.min.js', function () {  
        gfortSelectfn();
        });
    }
    ...
    if (jQuery('.video-block').length) {
        jQuery.getScript('bundles/app/js/plugins/fitvids/jquery.fitvids.min.js', function () {
            gfortFitVidfn();
        });
    }
    ...
    if (jQuery('.fancybox').length) {
        jQuery.getScript('bundles/app/js/plugins/fancybox/jquery.fancybox.pack.js', function () {
            jQuery.getScript('bundles/app/js/plugins/fancybox/helpers/jquery.fancybox-media.min.js', function () {
                gfortFancyBoxfn();
            });
        });
    }
    ...
    if (jQuery('audio').length) {
        jQuery.getScript('bundles/app/js/plugins/mediaelement/js/mediaelement-and-player.min.js', function () {
            gfortAudiofn();
        });
    }
    ...
    if (jQuery('.timer-block').length) {
        jQuery.getScript('bundles/app/js/plugins/downCount/jquery.downCount.min.js', function () {
            gfortTimerfn();
        });
    }
            ...
            success: function (response) {
                ...
                jQuery.each(mapMarkersLocation, function (index, response) {
                    ...
                    infoWindowOptions = {
                        ...
                        closeBoxURL: "bundles/app/js/plugins/infobox/close.png"
                    };
    ...
    if (jQuery('.gmap-block').length) {
        jQuery.getScript('https://maps.googleapis.com/maps/api/js?key=' + googleMapAPIKey, function () {
            jQuery.getScript('bundles/app/js/plugins/infobox/infobox_packed.js', function () {
                gfortGMapfn();
            });
        });
    }
    ...
    if (jQuery('.background-portfolio-grid').length) {
        jQuery.getScript('bundles/app/js/plugins/gridrotator/jquery.gridrotator.min.js', function () {
    ...
    if (jQuery('.filter-items-wrapper').length) {
        jQuery.getScript('bundles/app/js/plugins/isotope/isotope.pkgd.min.js', function () {
            gfortIsotopefn();
        });
    }
    ...
    if (jQuery('.photostack-block').length) {
        jQuery.getScript('bundles/app/js/plugins/photostack/classie.min.js', function () {
            jQuery.getScript('bundles/app/js/plugins/photostack/photostack.min.js', function () {
                gfortPhotoStackfn();
            });
        });
    }
    ...
    if (jQuery('.instagram-feed-block').length) {
        jQuery.getScript('bundles/app/js/plugins/gfortInsta/gfortInsta.min.js', function () {
            gfortInstafn();
        });
    }
    ...
    if (jQuery('.flickr-feed-block').length) {
        jQuery.getScript('bundles/app/js/plugins/flickr/jflickrfeed.min.js', function () {
            gfortFlickrfn();
        });
    }
    ...
    function gfortTwitterfn() {
        jQuery('.twitter-feed-block').twittie({
            ...
            loadingText: 'Loading ...',
            apiPath: 'bundles/app/js/plugins/tweetie/api/tweet.php',
    ...
    if (jQuery('.twitter-feed-block').length) {
        jQuery.getScript('bundles/app/js/plugins/tweetie/tweetie.js', function () {
            if (jQuery('.twitter-feed-block').hasClass('twitter-slider')) {
                jQuery.getScript('bundles/app/js/plugins/swiper/js/swiper.min.js');
            }
            gfortTwitterfn();
        });
    }
    ...
    if (blocksAtSameHeight === true) {
        jQuery.getScript('bundles/app/js/plugins/matchHeight/jquery.matchHeight.min.js', function () {
            gfortMatchHeightfn();
        });
    }
    ...
    if (pageSmoothScroll === true) {
        jQuery.getScript('bundles/app/js/plugins/smoothscroll/smoothscroll.min.js');
    }
